...
<?php endif; ?>
        ...
        ?>
        <div id="page-content">
            <span id="page-meta-data" data-title="Settings" hidden></span>
            ...
            <!-- Page Content -->
            <div class="px-4 py-3 transition-all duration-300">
                <div>
                    <!-- Profile Header -->
                    <div class="bg-white rounded-xl shadow-md p-6 mb-4">
                        <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                            <div class="relative">
                                ...
                                $fallback_url = "https://ui-avatars.com/api/?name=" . urlencode($fullname) . "&background=3B82F6&color=ffffff&size=120";
                            ...
                            <div class="text-center md:text-left">
                                <h2 class="text-2xl font-bold text-nsknavy"><?= htmlspecialchars($fullname) ?></h2>
                    ...
                    <!-- Tab Navigation (Only Account Settings for now) -->
                    <div class="border-b border-gray-200 bg-nsknavy rounded-t-lg">
                        <div class="px-6 py-4">
