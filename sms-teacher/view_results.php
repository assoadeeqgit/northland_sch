...
<?php endif; ?>
        ...
        <div id="page-content">
            ...
            <span id="page-meta-data" data-title="Student Results" hidden></span>
            <link rel="stylesheet" href="css/results.css">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-8">
                    <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4" onchange="handleResultFilterChange(this)">
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Session</label>
                            <select name="session_id" id="filterSessionId" class="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                        ...
                        <div>
                            ...
                            <select name="term_id" id="filterTermId" class="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                        ...
                        <div>
                            ...
                            <select name="class_id" id="filterClassId" class="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none">
            ...
            function handleResultFilterChange(form) {
                const formData = new FormData(form);
                const params = new URLSearchParams(formData);
                const url = `view_results.php?${params.toString()}`;
